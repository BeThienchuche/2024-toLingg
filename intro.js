var xinChao = 'Cùng đếm ngược thời gian với mình nha!';
    ...
    function startCountdown() {
        ...
        if (result) {
            ...
            while (seconds > 0) {
                alert('Cậu vui lòng đợi 1s nhé😁' + ': ' + seconds + ' giây');
                seconds--;
            }
    ...
    startCountdown();
       ...
       // Set the date we're counting down to
        const countDownDate = new Date("February 9, 2024 17:00:00 UTC").getTime();
